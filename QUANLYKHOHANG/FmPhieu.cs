...
namespace QUANLYKHOHANG
{
    ...
    {
        SqlConnection _cnn = new SqlConnection(@"Data Source=MSI\SQLEXPRESS2012;Initial Catalog=QUANLYKHOHANG;Integrated Security=True");
        SQL dt = new SQL();
        SqlCommand cmd;
        Modify modify = new Modify();
        string sql;
        SqlConnection ketnoi;
        string chuoiketnoi = @"Data Source=MSI\SQLEXPRESS2012;Initial Catalog=QUANLYKHOHANG;Integrated Security=True";
        SqlCommand thuchien;
...
//            }
        ...
        private void dataPN_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
