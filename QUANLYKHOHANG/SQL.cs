...
namespace QUANLYKHOHANG
{
    public class SQL
    {
        private static string _cnn = @"Data Source=MSI\SQLEXPRESS2012;Initial Catalog=QUANLYKHOHANG;Integrated Security=True";
       ...
       /// <returns></returns>
        ...
        {
            string stringconn = @"Data Source=MSI\SQLEXPRESS2012;Initial Catalog=QUANLYKHOHANG;Integrated Security=True";
